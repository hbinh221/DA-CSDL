...
values (N'No.8', 2500000, N'', GETDATE(), DATEADD(HH, 2, GETDATE()), 
...
select * from Flight
select * from Reservation where FlightId = 'ec267a45-1f80-ed11-be9f-484d7ef0b796' order by ReservationNo